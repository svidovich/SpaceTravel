...
/******************************************************************************
* SkewInverse is a linear map from so(3) to R3 which commutes with
* the respective Lie brackets (matrix bracket and cross-product)
******************************************************************************/
Vector3d SkewInverse(const Matrix3d A)
{
    Vector3d a;
...
/******************************************************************************
* Skew is a linear map from R3 to so(3) which is the
* inverse of SkewInverse
******************************************************************************/
...
Matrix3d MoserVeselov(const Matrix3d P, const Matrix3d J, const int iterate_bound, const double tol)
{
    ...
    {
        X = J*Q;        
        a = (X.trace()*Id - X).inverse() *(Q.transpose() * p + SkewInverse(X.transpose() - X));
