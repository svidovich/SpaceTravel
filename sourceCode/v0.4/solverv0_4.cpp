...
void JDEF(Matrix3d& J); // Function wrapper for definition of J
void JINPUT(Matrix3d& J); // Function for user input of inertia matrix
...
// Function opens files, talks to the user
	...
	while(cont)
	{
		...
		switch(choice)
		{
			case 1: // If user inputs 1, they want to define their own.
				...
				cont = false;
				break;
			case 2: // If user inputs 2, they want a tie fighter.
				J << 291.627, -89.6025, 0,
				    -89.6025, 227.676, 0,
					0, 0, 2105.72;
				cont = false;
				break;
			case 3: // If user inputs 3, they want a cube.
				J << 2.66666, 0, 0,
					0, 2.66666, 0,
					0, 0, 2.66666;
				cont = false;
